...
class BAparoi::armaDispo {
    public:
        ...
        vector<arma> getArmaCoupe(string coupeName, coteParoi cote) {
        ...
        void showArma(vector<arma> armaList) {
...
void BAparoi::calculArmaELU(map<string, float> inputData) {
        ...
        if (muybu > 0.25) {
            ...
            std::cout << "Error: muybu = " << muybu << ", d=" << d << ", MEd=" << inputData["MEd"] << std::endl;
